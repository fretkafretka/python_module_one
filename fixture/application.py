...
class Application:
    ...
    def create_client(self,client):
        ...
        wd.find_element_by_name("bday").send_keys(client.daybirthday)
        wd.find_element_by_name("bmonth").click()
        wd.find_element_by_name("bmonth").send_keys(client.monthbirthday)
        wd.find_element_by_name("byear").click()
        wd.find_element_by_name("byear").clear()
        wd.find_element_by_name("byear").send_keys(client.yearbirthday)
        wd.find_element_by_name("aday").click()
        wd.find_element_by_name("aday").send_keys(client.annday)
        wd.find_element_by_name("amonth").click()
        wd.find_element_by_name("amonth").send_keys(client.annmonth)
...
class ApplicationGroup:
    ...
    def return_to_groups_pade(self):
        wd = self.wd
